  ...
  return (
    <Main>
      ...
      <Section delay={0.2}>
        ...
        <Paragraph>
          I&apos;m an engineer and a self-taught web developer passionate about
          Cyber Security, Ethical Hacking and CTFs. I like solving challenges on
      ...
      <Section delay={0.3}>
        ...
        <SimpleGrid columns={[2, 2, 3]} gap={6} my={2}>
          {techsList.map((tech, idx) => (
            <Flex flexDirection="column" alignItems="center" gap={2} key={idx}>
              <Image
                key={idx}
                alt={tech.name}
                src={tech.href}
      ...
      <Section delay={0.5}>
        ...
        <List>
          ...
          <ListItem>
            <Link href="https://www.buymeacoffee.com/f0uadfS" target="_blank">
              <Button
                scroll={false}
                variant="ghost"
